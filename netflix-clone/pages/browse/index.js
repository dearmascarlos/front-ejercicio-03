  ...
  useEffect(() => {
    ...
    return (
        <div className="bg-black w-screen h-screen flex flex-col px-8">
           ...
           <Carousel topMovies={topMovies} title={'Movies'} type={'movie'} setModalVisible={setModalVisible} setModalContent={setModalContent} />
           <Carousel topMovies={topTv} title={'TV Series'} type={'tv'}  setModalVisible={setModalVisible} setModalContent={setModalContent}/>
           <Modal modalVisible={modalVisible} setModalVisible={setModalVisible} modalContent={modalContent}/>
        </div>
    );
}
