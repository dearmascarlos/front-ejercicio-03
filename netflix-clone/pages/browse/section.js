  ...
  return (
    <div className="text-white border-white w-2/3 max-h-xs mt-14 z-10">
      ...
      <div className='flex gap-3 mt-3'>
        <button className='flex items-center justify-center rounded-sm bg-slate-100 p-2 text-black w-20 h-8 text-sm'> <PlayIcon className='text-black mr-2 h-5'/>Play</button>
        <button className='flex items-center justify-center rounded-sm bg-gray-700 p-2 w-28 h-8 text-sm'><InformationCircleIcon className='text-white mr-2 h-5'/>More info</button>
      </div>
    </div>
  );
}
